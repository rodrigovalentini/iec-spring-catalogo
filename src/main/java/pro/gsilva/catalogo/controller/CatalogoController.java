...
public class CatalogoController {
    ...
    public ModelAndView getMusicas() {
        ...
        List<Categoria> categorias = categoriaService.findAllList();
    ...
    @GetMapping("/musicas/pesquisar-por-categoria")
    public ModelAndView pesquisarPorCategoria(@RequestParam("categoria") Long idCategoria) {
        ModelAndView mv = new ModelAndView("musicas");
        List<Musica> musicas = catalogoService.findByCategoria(idCategoria);
        List<Categoria> categorias = categoriaService.findAllList();
        mv.addObject("categorias", categorias);
        mv.addObject("musicas", musicas);
        return mv;
